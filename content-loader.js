...
(function () {
  ...
  function applyOverrides() {
    ...
    document.querySelectorAll('[data-cms]').forEach(el => {
      ...
      if (val === null) return; // no override — keep original HTML
  ...
  /**
   * Rebuild the explore.html art cards grid from localStorage JSON.
      ...
      card.innerHTML = `
        ...
        <div class="p-6 flex flex-col flex-grow">
          ...
          <div class="flex items-center justify-between mt-auto pt-4 border-t border-stone-100">
            ...
            <a href="payment.html?item=${encodeURIComponent(art.name || '')}&price=${art.price || 0}"
  ...
  /**
   * Rebuild dev team names on team.html
